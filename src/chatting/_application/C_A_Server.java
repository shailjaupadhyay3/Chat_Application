...
public class C_A_Server implements ActionListener {
 ...
 C_A_Server() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/s1.jpg"));
        Image i5 = i4.getImage().getScaledInstance(35, 35, Image.SCALE_SMOOTH);
        ...
        JLabel name = new JLabel("AshutoshPandeyyy");
